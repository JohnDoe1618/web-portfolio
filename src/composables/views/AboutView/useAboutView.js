...
export function useAboutView() {
    const baseServicesList = ref([
        ...
        },
        {
            ...
            desc: 'Разработка и управление серверами и базами данных. Мы предоставляем услуги по созданию, настройке, мониторингу и оптимизации серверной инфраструктуры',
            icon: serverIcon,
